...
export  function Footer() {
  return (
    <>
      ...
      <div class="text-center bg-purple p-10 ">
    <NavLink to={"/"}  className="flex items-center justify-center mb-5 text-2xl font-semibold text-purple-900">
        <i class="fa-solid fa-cart-shopping text-purple-600 me-2"></i> Fresh Cart
    </NavLink>

    <span class="block text-sm text-center text-gray-500">
        © All Rights Reserved.
        Made By <span className='text-purple-400'>Ahmed Hossam</span>
